...
plt.title("Time evolution of E from organized grid", fontsize=14)
plt.legend()
...
plt.xlabel("Number of MC-cycles", fontsize=12)
plt.ylabel("M", fontsize=12)
plt.title("Time evolution of M from randomized grid", fontsize=14)
plt.legend()
...
plt.xlabel("Number of MC-cycles", fontsize=12)
plt.ylabel("E", fontsize=12)
plt.title("Time evolution of E from randomized grid", fontsize=14)
plt.legend()
...
plt.xlabel("Number of MC-cycles", fontsize=12)
plt.ylabel("Number of accepted spin flips", fontsize=12)
plt.legend()
plt.title("Accepted configurations", fontsize=14)
