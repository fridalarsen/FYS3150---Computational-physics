...
plt.title("Mean energy of 2x2 lattice")
plt.legend()
...
plt.title("Mean magnetization of 2x2 lattice")
plt.legend()
...
plt.title("Specific heat of 2x2 lattice")
plt.legend()
...
plt.title("Susceptibility of 2x2 lattice")
plt.legend()
